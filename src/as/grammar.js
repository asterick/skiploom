...
var grammar = {
    ...
    {"name": "directive$ebnf$2$subexpression$1", "symbols": [{"literal":","}, {"literal":"WEAK"}]},
    ...
    {"name": "directive", "symbols": [{"literal":"SECT"}, "expression", "directive$ebnf$2", "directive$ebnf$3"], "postprocess": ([id,name,weak,reset]) => ({ type: "SectionDirective", name, reset: reset != null, weak: weak != null, location:location(id)})},
