...
var grammar = {
    ...
    {"name": "directive$ebnf$2$subexpression$1", "symbols": [{"literal":","}, {"literal":"RESET"}]},
    ...
    {"name": "directive", "symbols": [{"literal":"SECT"}, "expression", "directive$ebnf$2"], "postprocess": ([id,name,reset]) => ({ type: "SectionDirective", name, reset: reset != null, location:location(id)})},
    ...
    {"name": "directive$ebnf$3$subexpression$1", "symbols": [{"literal":"USING"}, "expression"], "postprocess": at(1)},
    ...
    {"name": "directive", "symbols": [{"literal":"INCLUDE"}, "expression", "directive$ebnf$3"], "postprocess": ([id, path, transform]) => ({ type: "IncludeDirective", path, transform, location:location(id) })},
    ...
    {"name": "directive$ebnf$4", "symbols": ["extern_attr_list"], "postprocess": id},
    {"name": "directive$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "directive", "symbols": [{"literal":"EXTERN"}, "directive$ebnf$4", "symbol_list"], "postprocess":  ([id,attributes,names]) => ({
    ...
    {"name": "directive$ebnf$5", "symbols": ["weak_attr"], "postprocess": id},
    {"name": "directive$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "directive", "symbols": [{"literal":"GLOBAL"}, "directive$ebnf$5", "symbol_list"], "postprocess": ([id, weak, names]) => ({ type: "GlobalDirective", weak: Boolean(weak), names, location:location(id) })},
    ...
    {"name": "directive$ebnf$6", "symbols": ["symbol"], "postprocess": id},
    {"name": "directive$ebnf$6", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "directive", "symbols": ["directive$ebnf$6", {"literal":"DUP"}, "expression", "eol", "source_body", {"literal":"ENDM"}], "postprocess": ([counter, id,count,,body]) => ({ type: "CountDupDirective", counter, count, body, location:location(id) })},
    {"name": "directive$ebnf$7", "symbols": ["symbol"], "postprocess": id},
    {"name": "directive$ebnf$7", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "directive", "symbols": ["directive$ebnf$7", {"literal":"DUPA"}, "symbol", {"literal":","}, "expression_list", "eol", "source_body", {"literal":"ENDM"}], "postprocess": ([counter, id,variable,,list,,body]) => ({ type: "ListDupDirective", counter, variable, list, body, location:location(id) })},
    {"name": "directive$ebnf$8", "symbols": ["symbol"], "postprocess": id},
    {"name": "directive$ebnf$8", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "directive", "symbols": ["directive$ebnf$8", {"literal":"DUPC"}, "symbol", {"literal":","}, "expression_list", "eol", "source_body", {"literal":"ENDM"}], "postprocess": ([counter, id,variable,,strings,,body]) => ({ type: "CharacterDupDirective", counter, variable, strings, body, location:location(id) })},
    {"name": "directive$ebnf$9", "symbols": ["symbol"], "postprocess": id},
    {"name": "directive$ebnf$9", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "directive$ebnf$10$subexpression$1", "symbols": [{"literal":","}, "expression"], "postprocess": at(1)},
    {"name": "directive$ebnf$10", "symbols": ["directive$ebnf$10$subexpression$1"], "postprocess": id},
    ...
    {"name": "directive", "symbols": ["directive$ebnf$9", {"literal":"DUPF"}, "symbol", "directive$ebnf$10", {"literal":","}, "expression", "directive$ebnf$11", "eol", "source_body", {"literal":"ENDM"}], "postprocess": ([counter, id,variable,start,,end,step,,body]) => ({ type: "SequenceDupDirective", counter, variable, start, end, step, body, location:location(id) })},
    ...
    {"name": "expression", "symbols": [{"literal":"["}, "logical_or_expr", {"literal":"]"}], "postprocess": ([id, address,]) => ({ type:"IndirectMemory", address, location:location(id) })},
    {"name": "expression", "symbols": [{"literal":"["}, "logical_or_expr", {"literal":":"}, "logical_or_expr", {"literal":"]"}], "postprocess": ([id, register, _, offset,]) => ({ type:"IndirectRegisterOffset", register, offset, location:location(id) })},
